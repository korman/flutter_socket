...
class OtherLockNode extends $pb.GeneratedMessage {
  ...
  factory OtherLockNode.fromBuffer($core.List<$core.int> i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(i, r);
  factory OtherLockNode.fromJson($core.String i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
  ...
  @$core.Deprecated('Using this can add significant overhead to your binary. '
      ...
      'Will be removed in next major version')
  OtherLockNode copyWith(void Function(OtherLockNode) updates) =>
      super.copyWith((message) => updates(message as OtherLockNode))
          as OtherLockNode; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  static OtherLockNode create() => OtherLockNode._();
  OtherLockNode createEmptyInstance() => create();
  static $pb.PbList<OtherLockNode> createRepeated() =>
      $pb.PbList<OtherLockNode>();
  @$core.pragma('dart2js:noInline')
  static OtherLockNode getDefault() => _defaultInstance ??=
      $pb.GeneratedMessage.$_defaultFor<OtherLockNode>(create);
...
class OtherInputText extends $pb.GeneratedMessage {
  ...
  factory OtherInputText.fromBuffer($core.List<$core.int> i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(i, r);
  factory OtherInputText.fromJson($core.String i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromJson(i, r);
  @$core.Deprecated('Using this can add significant overhead to your binary. '
      'Use [GeneratedMessageGenericExtensions.deepCopy] instead. '
  ...
  @$core.Deprecated('Using this can add significant overhead to your binary. '
      'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
      'Will be removed in next major version')
  OtherInputText copyWith(void Function(OtherInputText) updates) =>
      super.copyWith((message) => updates(message as OtherInputText))
          as OtherInputText; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  static OtherInputText create() => OtherInputText._();
  OtherInputText createEmptyInstance() => create();
  static $pb.PbList<OtherInputText> createRepeated() =>
      $pb.PbList<OtherInputText>();
  @$core.pragma('dart2js:noInline')
  static OtherInputText getDefault() => _defaultInstance ??=
      $pb.GeneratedMessage.$_defaultFor<OtherInputText>(create);
