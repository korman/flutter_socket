...
class RegisterResult extends $pb.ProtobufEnum {
  static const RegisterResult REG_SUCCEEDED = RegisterResult._(
      0,
      const $core.bool.fromEnvironment('protobuf.omit_enum_names')
          ? ''
          : 'REG_SUCCEEDED');
  static const RegisterResult REG_DUPLICATE = RegisterResult._(
      1,
      const $core.bool.fromEnvironment('protobuf.omit_enum_names')
          ? ''
          : 'REG_DUPLICATE');
  ...
  static final $core.Map<$core.int, RegisterResult> _byValue =
...
class LockResult extends $pb.ProtobufEnum {
  static const LockResult LOCK_SUCCEEDED = LockResult._(
      0,
      const $core.bool.fromEnvironment('protobuf.omit_enum_names')
          ? ''
          : 'LOCK_SUCCEEDED');
  static const LockResult LOCK_FAILED = LockResult._(
      1,
      const $core.bool.fromEnvironment('protobuf.omit_enum_names')
          ? ''
          : 'LOCK_FAILED');
  ...
  static final $core.Map<$core.int, LockResult> _byValue =
      $pb.ProtobufEnum.initByValue(values);
